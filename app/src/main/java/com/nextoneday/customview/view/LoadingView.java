...
public class LoadingView extends View {
    ...
    private void loadAttrs(Context context, AttributeSet attrs) {
        ...
        paintBold = array.getDimensionPixelSize(R.styleable.my_view_paintBold, 10);
        lineLength = array.getDimensionPixelSize(R.styleable.my_view_lineLength, 25);
        bgPaintColor = array.getColor(R.styleable.my_view_backgroundColor, Color.GRAY);
        beforePaintColor = array.getColor(R.styleable.my_view_beforeColor, Color.YELLOW);
        lines = array.getInt(R.styleable.my_view_lines, 20);
        max = array.getInt(R.styleable.my_view_max, 100);
        progress = array.getInt(R.styleable.my_view_progress, 0);
        textColor = array.getColor(R.styleable.my_view_textColor, Color.BLACK);
        array.recycle();
    }
